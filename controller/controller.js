...
router.get('/scrape', function(req, res){
    ...
    request('http://www.theverge.com/tech', function(error, response, html) {
        ...
        $('.c-entry-box--compact__title').each(function(i,element){
            ...
            //Add the text and href of everylink, and save them as properties of the result object
            result.title=$(this).children('a').text();
            result.link = $(this).children('a').attr('href');

            //ensures that no empty title of links are sent to mongodb
            ...
            //Log that the scrape is working, just the content was missing parts
            else{
...
//This will get the articles scraped from mongoDB in JSON
